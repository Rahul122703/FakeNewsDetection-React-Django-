...
def get_new_news_from_api_and_update():
    ...
    news_data = requests.get("https://content.guardianapis.com/search?api-key=8f281091-8da1-4bcf-8fd6-1b98b301cabb")
    # news_data = requests.get("https://content.guardianapis.com/search?api-key=test")
